...
- Note that you are doing two things above that you cannot do in
  anonymous relations: `advanced_students` referring to the relation
  `fsummary` just defined above and the query refers to the defined
  relation `advanced_relations` in the WHERE statement, while this
  cannot be done in anonymous relations.
...
- While WITH statement is quite powerful as a construct, be very
  ...
  written with a simple block of SQL:
